...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
    ...
    def __init__(self, bam_number=None, conf_file=None):
        ...
        if bam_number:
            if bam_number > 1:
                print("Create an empty configuration file, appropriate for {} bam files, in the current folder.".format(bam_number))
            else:
                print("Create an empty configuration file, appropriate for {} bam file, in the current folder.".format(bam_number))
        ...
        try:
            ...
            if self.config.getboolean("SupplementaryOutput", "supplementary_output"):
                ...
                if not self.config.get("SupplementaryOutput", "supplementary_output_prefix"):
                    ...
                    self.supplementary_output_prefix = self.config.get("SupplementaryOutput", "supplementary_output_prefix")
                ...
                if  self.supplementary_output_format not in ('png', 'pdf', 'tif', 'ps', 'eps'):
                    print("The 'supplementary_output_format' option of the configuration file is not in the correct format")
                    print ("Please report to the descriptions in the configuration file\n")
                    exit()
            ...
            with open (bed_name, "w+") as bed_file:
                ...
                if read_exist:
                    ...
                    for pileupcolumn in bam.pileup(self.reference_name, max_depth=100000000):
                        ...
                        bed_file.write("{}\t{}\t{}\t{}\n".format(self.reference_name, base_position-1, base_position, pileupcolumn.n))
